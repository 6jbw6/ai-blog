        ...
        <div class="features-matrix">
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <el-icon :size="22" class="feature-icon"><Box /></el-icon>
            </div>
            <h3 class="feature-title">全栈工程架构</h3>
            <p class="feature-desc">
              FastAPI + Vue3 + TypeScript + MySQL 8.0 工业级规范落地，RBAC 细粒度权限管控。
            </p>
          </div>

          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <el-icon :size="22" class="feature-icon"><Cpu /></el-icon>
            </div>
            <h3 class="feature-title">RAG 向量检索</h3>
            <p class="feature-desc">
              Markdown 标题树切片感知，128 维稠密特征投影与亚毫秒级内存余弦相似度召回。
            </p>
          </div>
          ...
          <div class="feature-card">
            ...
            <h3 class="feature-title">SSE 流式交互</h3>
            <p class="feature-desc">
              大模型打字机流式输出，结构化事件驱动与知识库切片来源可信溯源卡片。
            </p>
          </div>
          ...
          <div class="feature-card">
            ...
            <h3 class="feature-title">系统工程与设计</h3>
            <p class="feature-desc">
              博文多维统计词云、Pydantic V2 数据模型校验与全生命周期开发日志追踪。
            </p>
          </div>
        </div>
      </section>
